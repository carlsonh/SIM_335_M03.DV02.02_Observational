...
public class player_movement : MonoBehaviour
{
    ...
    public delegate void PlayerXPos(float xPos);
    public static event PlayerXPos OnPlayerXUpdate; //Define: Contrived
    ...
    void FixedUpdate()
    {
        ...
        OnPlayerSpeedUpdate?.Invoke(rb.velocity.z);

        OnPlayerZUpdate?.Invoke(transform.position.z);

        OnPlayerXUpdate?.Invoke(transform.position.x);
